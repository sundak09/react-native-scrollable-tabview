...
class ScrollableTabView extends Component {
  constructor(props) {
    ...
    this._onMomentumScrollBeginAndEnd =
      this._onMomentumScrollBeginAndEnd.bind(this);
  ...
  render() {
    ...
    const ContainerView = this.props.collapsableBar
      ? Animated.ScrollView
      : View;
